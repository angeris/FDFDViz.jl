...
function plot_field(field::Field; cbar::Bool=false, funcz=real, component=nothing)
	...
	p = heatmap(Z, c=cmap, extent=extents, origin="lower", clims=(vmin, vmax), label="||E||", size=(400,400))
	xlabel!("x")
	ylabel!("y")
...
function plot_device(device::AbstractDevice; outline::Bool=true, lc::String="k", lcm::String="k")
